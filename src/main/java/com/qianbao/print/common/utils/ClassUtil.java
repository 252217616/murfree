...
public class ClassUtil {
	 ...
	 * @return
	 */
	public static boolean isSubType(Class<?> clazz, Class<?> superClazz) {
		Validate.notNull(clazz, "clazz must not be null");
		Validate.notNull(superClazz, "superClazz must not be null");
	 ...
	 * @param subClazz 子类
	 */
	public static boolean isSuperType(Class<?> clazz, Class<?> subClazz) {
		Validate.notNull(clazz, "clazz must not be null");
		Validate.notNull(subClazz, "subClazz must not be null");
